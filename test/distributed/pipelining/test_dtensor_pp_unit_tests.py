...
Tests the _utils.py metadata infrastructure:
...
class TestMetadataClasses(DTensorPPTestBase):
    """Unit tests for _TensorMeta, _DTensorMeta, _MeshCache."""
...
class TestInferenceModeLogic(DTensorPPTestBase):
    """Unit tests for InferenceMode.needs_dynamic() decision matrix."""
...
class TestValidation(DTensorPPTestBase):
    """Unit tests for validate_metadata, validate_tensors_metadata,
    and validate_static_dtensor_grad_correspondence."""
    ...
    def test_validate_static_dtensor_grad_correspondence(self):
        ...
        # DTensor(requires_grad=True) + None grad → ERROR
        with self.assertRaises(PipeliningMetadataError):
            validate_static_dtensor_grad_correspondence(
...
class TestHelperFunctions(DTensorPPTestBase):
    """Unit tests for extract_tensor_metas, to_local_if_dtensor,
    validate_and_normalize_to_tuple."""
